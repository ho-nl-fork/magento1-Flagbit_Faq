 ...
 *
 */
class Flagbit_Faq_Block_Adminhtml_Item_Widget_Chooser extends Flagbit_Faq_Block_Adminhtml_Item_Grid
{
    /**
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('*/faq/itemChooser', array('uniq_id' => $uniqId));
        ...
        if ($element->getValue()) {
            /* @var $gallery Flagbit_Faq_Model_Faq */
            $gallery = Mage::getModel('flagbit_faq/faq')->load($element->getValue());
            if ($gallery->getId()) {
                $chooser->setLabel($gallery->getQuestion());
            }
        }
    ...
    {
        return $this->getUrl('*/faq/itemChooser', array('_current' => true));
    }
